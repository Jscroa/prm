...
public class CustomToAddrDaoImpl implements ICustomToAddrDao {
	...
	public CustomToAddr get(String id) {
		...
		List<CustomToAddr> list = jdbcTemplate.query(sql, new Object[] { id },
				new RowMapper<CustomToAddr>() {
	...
	public List<Address> getAddresses(String customId) {
		...
		List<Address> list = jdbcTemplate.query(sql, new Object[]{customId,DB_STATUS.STATUS_ACTIVE,DB_STATUS.STATUS_ACTIVE},new RowMapper<Address>(){
