...
/**
 * @Title: AccToGroupDaoImpl.java<br>
 * @Package: cn.prm.server.dao.impl<br>
 * @Description: <br>
 * @author yyao<br>
 * @date 2016年10月19日 下午5:29:30<br>
 * @version v1.0<br>
 */
@Repository
public class AccToGroupDaoImpl implements IAccToGroupDao {
    ...
    public AccToGroup get(String id) {
        ...
        List<AccToGroup> list = jdbcTemplate.query(sql, new Object[] { id }, new RowMapper<AccToGroup>() {
    ...
    public List<Account> getAccounts(String groupId) {
        ...
        List<Account> list = jdbcTemplate.query(sql,
                new Object[] { groupId, DB_STATUS.STATUS_ACTIVE, DB_STATUS.STATUS_ACTIVE }, new RowMapper<Account>() {
