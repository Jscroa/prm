...
/**
 * @Title: CustomToContactDaoImpl.java<br>
 * @Package: cn.prm.server.dao.impl<br>
 * @Description: <br>
 * @author yyao<br>
 * @date 2016年10月19日 下午5:29:58<br>
 * @version v1.0<br>
 */
@Repository
public class CustomToContactDaoImpl implements ICustomToContactDao {
    ...
    public CustomToContact get(String id) {
        ...
        List<CustomToContact> list = jdbcTemplate.query(sql, new Object[] { id }, new RowMapper<CustomToContact>() {
    ...
    public List<Contact> getContacts(String customId) {
        ...
        List<Contact> list = jdbcTemplate.query(sql,
                new Object[] { customId, DB_STATUS.STATUS_ACTIVE, DB_STATUS.STATUS_ACTIVE }, new RowMapper<Contact>() {
