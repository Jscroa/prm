...
<body>
	...
	var dlg_load_html_str = '<div class="sk-spinner sk-spinner-wave"><div class="sk-rect1"></div><div class="sk-rect2"></div><div class="sk-rect3"></div><div class="sk-rect4"></div><div class="sk-rect5"></div></div>';
                   ...
                   if (data) {
                       if (data.code == 100) {
                           ...
                           for(var i=0;i<data.rows.length;i++){
                               options += '<option value="'+data.rows[i].id+'">'+data.rows[i].cnName+','+data.rows[i].enName+','+data.rows[i].shortName+'</option>';
                           }
                           dlg.init(function(){
